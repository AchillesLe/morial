...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo URL_CSS.'/line-icons.css' ?>">
    <link rel="stylesheet" href="<?php echo URL_CSS.'/owl.carousel.css' ?>">
    <link rel="stylesheet" href="<?php echo URL_CSS.'/owl.theme.css' ?>">
    <link rel="stylesheet" href="<?php echo URL_CSS.'/nivo-lightbox.css' ?>">
    <link rel="stylesheet" href="<?php echo URL_CSS.'/magnific-popup.css' ?>">
    <link rel="stylesheet" href="<?php echo URL_CSS.'/slicknav.css' ?>">
    <link rel="stylesheet" href="<?php echo URL_CSS.'/animate.css' ?>">
    <link rel="stylesheet" href="<?php echo URL_CSS.'/main.css' ?>">    
    <link rel="stylesheet" href="<?php echo URL_CSS.'/responsive.css' ?>">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar indigo">
        <div class="container">
          ...
          <div class="navbar-header">
            <a href="index.html" class="navbar-brand"><img class="img-fulid" src="<?php echo URL_IMGS.'/logo.png' ?>" alt=""></a>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-xs-12">
            <div class="show-box">
              <img class="img-fulid" src="<?php echo URL_IMGS.'/features/feature.png' ?>" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div id="portfolio" class="row">
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development print">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php URL_IMGS.'/portfolio/img1.jpg' ?>" alt="" />  
                  <a class="overlay lightbox" href="<?php echo URL_IMGS.'/portfolio/img1.jpg' ?>">
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix design print">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php URL_IMGS.'/portfolio/img2.jpg' ?>" alt="" />  
                  <a class="overlay lightbox" href="<?php echo URL_IMGS.'/portfolio/img2.jpg ' ?>">
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>               
              </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php URL_IMGS.'/portfolio/img3.jpg' ?>" alt="" />  
                  <a class="overlay lightbox" href="<?php echo URL_IMGS.'/portfolio/img3.jpg' ?>">
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>               
              </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development design">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php URL_IMGS.'/portfolio/img4.jpg' ?>" alt="" />  
                  <a class="overlay lightbox" href="<?php echo URL_IMGS.'/portfolio/img4.jpg' ?>">
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>               
              </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php URL_IMGS.'/portfolio/img5.jpg' ?>" alt="" />  
                  <a class="overlay lightbox" href="<?php echo URL_IMGS.'/portfolio/img5.jpg' ?>">
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>               
              </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix print design">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="<?php URL_IMGS.'/portfolio/img6.jpg' ?>" alt="" />  
                  <a class="overlay lightbox" href="<?php echo URL_IMGS.'/portfolio/img6.jpg' ?>">
                    <i class="lnr lnr-eye item-icon"></i>
                  </a>
                </div>               
              </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="<?php echo URL_IMGS.'/team/team1.jpg' ?> " alt="">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="<?php echo URL_IMGS.'/team/team2.jpg' ?>" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="<?php echo URL_IMGS.'/team/team3.jpg' ?>" alt="">
              <div class="team-details">
                <div class="team-inner">                  
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img class="img-fulid" src="<?php echo URL_IMGS.'/team/team4.jpg' ?>" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-md-12">
            <div class="touch-slider owl-carousel owl-theme">
              <div class="testimonial-item">
                <img src="<?php echo URL_IMGS.'/testimonial/customer1.jpg' ?>" alt="Client Testimonoal" />
              ...
              <div class="testimonial-item">
                <img src="<?php echo URL_IMGS.'/testimonial/customer2.jpg' ?>" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. send do <br> adipisicing ciusmod tempor incididunt ut labore et</p>
                  <h3>Oidila Matik</h3>
              ...
              <div class="testimonial-item">
                <img src="<?php echo URL_IMGS.'/testimonial/customer3.jpg' ?>" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. send do <br> adipisicing ciusmod tempor incididunt ut labore et</p>
                  <h3>Alex Dattilo</h3>
              ...
              <div class="testimonial-item">
                <img src="<?php echo URL_IMGS.'/testimonial/customer4.jpg' ?>" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. send do <br> adipisicing ciusmod tempor incididunt ut labore et</p>
                  <h3>Paul Kowalsy</h3>
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php echo URL_IMGS.'/blog/img1.jpg' ?>" alt="">
                </a>                
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php echo URL_IMGS.'/blog/img2.jpg' ?>" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <div class="meta-tags">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="<?php echo URL_IMGS.'/blog/img3.jpg' ?>" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <div class="meta-tags">
    ...
    <script src="<?php echo URL_JS.'/popper.min.js' ?>"></script>
    <script src="<?php echo URL_JS.'/bootstrap.min.js' ?>"></script>
    <script src="<?php echo URL_JS.'/jquery.mixitup.js' ?>"></script>
    <script src="<?php echo URL_JS.'/nivo-lightbox.js' ?>"></script>
    <script src="<?php echo URL_JS.'/owl.carousel.js' ?>"></script>    
    <script src="<?php echo URL_JS.'/jquery.stellar.min.js' ?>"></script>    
    <script src="<?php echo URL_JS.'/jquery.nav.js' ?>"></script>    
    <script src="<?php echo URL_JS.'/scrolling-nav.js' ?>"></script>    
    <script src="<?php echo URL_JS.'/jquery.easing.min.js' ?>"></script>    
    <script src="<?php echo URL_JS.'/smoothscroll.js' ?>"></script>    
    <script src="<?php echo URL_JS.'/jquery.slicknav.js' ?>"></script>     
    <script src="<?php echo URL_JS.'/wow.js' ?>"></script>   
    <script src="<?php echo URL_JS.'/jquery.vide.js' ?>"></script>
    <script src="<?php echo URL_JS.'/jquery.counterup.min.js' ?>"></script>    
    <script src="<?php echo URL_JS.'/jquery.magnific-popup.min.js' ?>"></script>    
    <script src="<?php echo URL_JS.'/waypoints.min.js' ?>"></script>    
    <script src="<?php echo URL_JS.'/form-validator.min.js' ?>"></script>
    <script src="<?php echo URL_JS.'/contact-form-script.js' ?>"></script>   
